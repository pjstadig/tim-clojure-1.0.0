...
static public Symbol intern(String ns, String name){
	return (Symbol)(Object) new SymbolTC(ns == null ? null : ns.intern(), name.intern());
}

static public Symbol intern(String nsname){
	int i = nsname.lastIndexOf('/');
	if(i == -1)
		return (Symbol)(Object) new SymbolTC(null, nsname.intern());
	else
		return (Symbol)(Object) new SymbolTC(nsname.substring(0, i).intern(), nsname.substring(i + 1).intern());
}

static public Symbol create(String name_interned){
	return (Symbol)(Object) new SymbolTC(null, name_interned);
}

static public Symbol create(String ns_interned, String name_interned){
	return (Symbol)(Object) new SymbolTC(ns_interned, name_interned);
}
